...
{
    public partial class Context_UniHotel_Prod : DbContext
    {
        public Context_UniHotel_Prod()
        {

        }

        public Context_UniHotel_Prod(DbContextOptions<Context_UniHotel_Prod> options)
            : base(options)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                optionsBuilder.UseSqlServer(configuration["ConnectionString:DB_UniHotel_Prod"]);
            }
        }
